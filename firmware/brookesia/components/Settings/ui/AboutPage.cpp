...
const char *product_name()
{
    ...
    return "ESP32-P4-WIFI6-Touch-LCD-7";
#elif CONFIG_BSP_LCD_TYPE_800_1280_8_INCH
    return "ESP32-P4-WIFI6-Touch-LCD-8";
#elif CONFIG_BSP_LCD_TYPE_800_1280_10_1_INCH
    return "ESP32-P4-WIFI6-Touch-LCD-10.1";
#else
    return "ESP32-P4-WIFI6-Touch-LCD-X";
#endif
}
